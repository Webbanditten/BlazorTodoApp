...
public class DummyDataService : IDummyDataService
{
  ...
  Task<IEnumerable<TodoListItem>> IDummyDataService.GetRandomTodoItems(int count)
  {
    ...
    for (var i = 0; i < count; i++)
    {
      ...
      var todoListItem = new TodoListItem { Title = title, Metadata = new TodoListItemMetadata { IsDone = isDone, CreatedAt = createdAt, CompletedAt = completedAt } };
